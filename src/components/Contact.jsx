const socialLinks = [
    {
      href: 'https://github.com/SucharithaPolimera',
    ...
    {
      href: 'https://www.linkedin.com/in/polimera-sucharitha-b0572a186/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://x.com/sucharitha6032',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/sucharithahahaha/',
        ...
        <section id="contact" className="section">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex-col">
                    <h2 className="headline-2 lg:max-w-[12ch] reveal-up">Contact me for discussions.</h2>
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up"> Reach out today to discuss on project needs and start collaborating on something amazing!!</p>
                ...
                <form action="https://getform.io/f/adrnqrna" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="name" className="label reveal-up">Name</label>
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Sucharitha Polimera" className="text-field reveal-up"/>
                        </div>

                        <div className="mb-4">
                            <label htmlFor="email" className="label reveal-up">Email</label>
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="sucharitha@gmail.com" className="text-field reveal-up"/>
                        </div>
